...
NET_UPLIFTS = {
    "computer_science": 8, "other": 8, "psychology": 7, "biology": 6,
    "math": 5, "business": 3, "philosophy": 3,
    "economics": 2, "engineering": 2, "law": 2,
    "chemistry": 1, "physics": 1, "history": 0, "health": -2,
}
...
class CalibrationScenario(Scenario):
    ...
    @property
    def name(self) -> str:
        return "calibration_tuning_causal_tracing"
    ...
    def display_iteration(
        ...
        conflict = sum(
            ...
            if "priority_conflict" in d.get("failure_kind", ""))
        print(f"\n  Diagnosis summary: {len(diagnoses)} failures")
        print(f"    structural: {structural}, parametric: {parametric}, "
