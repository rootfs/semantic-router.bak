...
impl Qwen3EmbeddingModelBatched {
    ...
    pub fn embedding_forward(
        ...
        let input_batch_size = input_ids.dim(0).map_err(|e| crate::core::UnifiedError::Processing {
        ...
        if input_batch_size > 1 {
            ...
            for i in 0..input_batch_size {
                ...
                let single_input_ids = input_ids.get(i).and_then(|t| t.unsqueeze(0))
                ...
                let single_attention_mask = attention_mask.get(i).and_then(|t| t.unsqueeze(0))
                    .map_err(|e| crate::core::UnifiedError::Processing {
                ...
                let ids_raw = single_input_ids.to_vec2::<u32>()
                    .map_err(|e| crate::core::UnifiedError::Processing {
                ...
                let mask_raw = single_attention_mask.to_vec2::<u32>()
                    .map_err(|e| crate::core::UnifiedError::Processing {
            ...
            Tensor::new(embedding_vecs, &self.device).map_err(|e| crate::core::UnifiedError::Processing {
            ...
            let ids_raw = input_ids.to_vec2::<u32>()
                .map_err(|e| crate::core::UnifiedError::Processing {
            ...
            let mask_raw = attention_mask.to_vec2::<u32>()
                .map_err(|e| crate::core::UnifiedError::Processing {
            ...
            let embedding_vec = self.scheduler.embed_from_raw(ids_raw, mask_raw)?;
            Tensor::new(vec![embedding_vec], &self.device).map_err(|e| crate::core::UnifiedError::Processing {
    ...
    pub fn embedding_forward_from_raw(
        ...
        self.scheduler.embed_from_raw(input_ids_raw, attention_mask_raw)
    }
