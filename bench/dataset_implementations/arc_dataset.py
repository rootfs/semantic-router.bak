...
class ARCDataset(DatasetInterface):
    ...
    def _load_raw_dataset(self):
        ...
        if self.variant in ["challenge", "both"]:
            challenge_dataset = load_dataset("allenai/ai2_arc", "ARC-Challenge", split="test")
    ...
    def _extract_subject_from_question(self, question: str, choices: List[str]) -> str:
        ...
        # Physics keywords
        physics_keywords = [
            'force', 'energy', 'motion', 'gravity', 'mass', 'velocity', 'acceleration',
            'friction', 'magnet', 'electric', 'current', 'voltage', 'circuit', 'light',
            'sound', 'wave', 'heat', 'temperature', 'pressure', 'density'
        ]
        
        # Chemistry keywords  
        chemistry_keywords = [
            'atom', 'molecule', 'element', 'compound', 'chemical', 'reaction',
            'acid', 'base', 'ph', 'solution', 'mixture', 'gas', 'liquid', 'solid',
            'metal', 'oxygen', 'hydrogen', 'carbon', 'ion', 'bond'
        ]
        
        # Biology keywords
        biology_keywords = [
            'cell', 'organism', 'plant', 'animal', 'bacteria', 'virus', 'gene',
            'dna', 'protein', 'enzyme', 'photosynthesis', 'respiration', 'evolution',
            'ecosystem', 'habitat', 'species', 'population', 'food', 'nutrition'
        ]
        
        # Earth Science keywords
        earth_keywords = [
            'earth', 'planet', 'rock', 'mineral', 'soil', 'weather', 'climate',
            'atmosphere', 'ocean', 'river', 'mountain', 'volcano', 'earthquake',
            'fossil', 'geology', 'solar system', 'moon', 'sun', 'star'
        ]
